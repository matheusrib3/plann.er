            ...
            <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
                ...
                <div className='space-y-2'>
                    ...
                    <p className='text-sm text-zinc-400'>
                        Para concluir a criação da viagem para <span className='text-zinc-100 font'>Florianópolis</span>, Brasil nas datas de <span className='text-zinc-100 font'> 16 a 27 de Agosto de 2024 </span> preencha seus dados abaixo:
                    </p>
